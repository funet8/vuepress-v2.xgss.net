...
![img](https://imgoss.xgss.net/picgo-tx2026/QQ_1770103754133.png?tx)

这将删除隧道，但 cloudflared 进程仍会在您安装了 XXXXX 令牌的所有计算机上运行。要删除此进程，在每台计算机上运行`sudo cloudflared service uninstall`。

再到nas中继续执行

```
root@star-fnas:~# cloudflared service uninstall
2026-02-03T07:32:45Z INF Using Systemd
2026-02-03T07:32:46Z INF Linux service for cloudflared uninstalled successfully
```
