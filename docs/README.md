...
|        vuepress         | [vuepress-v2.xgss.net](http://vuepress-v2.xgss.net/) | vuepress.xgss.net 基于vuepress搭建站点                       |                                                     |
...
[关于最近很火的Nano Banana以及结合开源项目的100种玩法](https://mp.weixin.qq.com/s/JRZ90stTO-fA8pezGVKB9Q)
...
- [免费全自动申请和自动部署更新SSL证书的开源系统-certd](https://mp.weixin.qq.com/s/-v8XL1kSvbylpn3Mz2Kwpw)
- [通过acme.sh开源工具申请泛解析SSL证书](https://mp.weixin.qq.com/s/xsgAfdSN8zphv0PccTQXqg)
