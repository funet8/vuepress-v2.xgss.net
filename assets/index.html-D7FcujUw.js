import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as i,o as e}from"./app-B4PqXO1v.js";const l={};function p(d,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="linux服务器配置ssh免密码登陆" tabindex="-1"><a class="header-anchor" href="#linux服务器配置ssh免密码登陆"><span>Linux服务器配置SSH免密码登陆</span></a></h1><h2 id="实现功能" tabindex="-1"><a class="header-anchor" href="#实现功能"><span>实现功能</span></a></h2><p>node179，node181，node182上实现www用户免密码访问，密钥登录。</p><p>在三台服务器上设置www的密码</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>#passwd www </span></span>
