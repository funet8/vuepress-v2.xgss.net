import{_ as a}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,b as i,o as e}from"./app-B4PqXO1v.js";const l={};function p(r,s){return e(),n("div",null,s[0]||(s[0]=[i(`<h1 id="apollo的部署和动态配置基础使用" tabindex="-1"><a class="header-anchor" href="#apollo的部署和动态配置基础使用"><span>Apollo的部署和动态配置基础使用</span></a></h1><h2 id="简介" tabindex="-1"><a class="header-anchor" href="#简介"><span>简介</span></a></h2><p>Apollo（阿波罗）是携程框架部门研发的分布式配置中心，能够集中化管理应用不同环境、不同集群的配置，以及能实现灰度发布等实现，配置修改后能够动态推送到应用端，并且具备规范的权限、流程治理等特性，适用于微服务配置管理场景。</p><h2 id="服务器环境" tabindex="-1"><a class="header-anchor" href="#服务器环境"><span>服务器环境</span></a></h2><h3 id="测试系统介绍" tabindex="-1"><a class="header-anchor" href="#测试系统介绍"><span>测试系统介绍</span></a></h3><table><thead><tr><th>系统</th><th>Centos7</th></tr></thead><tbody><tr><td>java环境</td><td>java1.8</td></tr><tr><td>数据库</td><td>MariaDB-10.2.9</td></tr><tr><td>IP</td><td>192.168.1.3</td></tr></tbody></table><h3 id="安装java" tabindex="-1"><a class="header-anchor" href="#安装java"><span>安装java</span></a></h3><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
