import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as i,o as e}from"./app-DbDHfX93.js";const l={};function p(d,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="快速搭建专属的私人网盘系统-ifilespace" tabindex="-1"><a class="header-anchor" href="#快速搭建专属的私人网盘系统-ifilespace"><span>快速搭建专属的私人网盘系统-iFileSpace</span></a></h1><h2 id="ifilespace介绍" tabindex="-1"><a class="header-anchor" href="#ifilespace介绍"><span>iFileSpace介绍</span></a></h2><p>iFileSpace 是一个在线个人文件管理工具，在线网盘程序，可快速一键搭建私人云盘，支持本地存储和对象存储（阿里云oss,腾讯云cos,华为云obs,又拍云,七牛云,OneDrive及其他支持S3协议对象存储）, 如部署在公网服务器，可替代百度网盘等在线网盘，自主搭建，数据完全自主管理！也可部署在家庭软路由、nas等个人存储设备中，作为局域网文件管理工具使用。支持多用户、多存储空间、资料库、webdav、离线下载及精细的后台权限管理。</p><p>iFileSpace 是一款 Go 语言开发的免费在线个人文件管理工具 (免费网盘架设程序)，你可以用它在 VPS 服务器或局域网电脑上快速一键搭建私人云盘。软件支持将用户的文件数据保存在本地存储，或者保存到后端对象存储服务去 (如阿里云 OSS、华为云 OBS、OneDrive 等）</p><p><img src="https://imgoss.xgss.net/picgo/iFileSpace.jpg?aliyun" alt="iFileSpace"></p><h2 id="安装流程" tabindex="-1"><a class="header-anchor" href="#安装流程"><span>安装流程</span></a></h2><p>官方网站： https://ifile.space/</p><p>安装文档： https://ifile.space/docs/home</p><p>本地安装系统说明</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>系统：centos7</span></span>
