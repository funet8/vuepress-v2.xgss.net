import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as e,o as i}from"./app-w0bMFjFL.js";const l={};function p(t,s){return i(),a("div",null,s[0]||(s[0]=[e(`<h1 id="配置docker配置镜像加速器" tabindex="-1"><a class="header-anchor" href="#配置docker配置镜像加速器"><span>配置Docker配置镜像加速器</span></a></h1><h2 id="配置docker配置镜像加速器-1" tabindex="-1"><a class="header-anchor" href="#配置docker配置镜像加速器-1"><span>配置Docker配置镜像加速器</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>vi /etc/docker/daemon.json</span></span>
