import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,a as i,o as e}from"./app-CkVikb64.js";const l={};function p(d,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="网络监控工具-ping、traceroute、nmap、wireshark-网络探测与分析" tabindex="-1"><a class="header-anchor" href="#网络监控工具-ping、traceroute、nmap、wireshark-网络探测与分析"><span>网络监控工具：ping、traceroute、nmap、Wireshark 网络探测与分析</span></a></h1><p>在现代网络环境中，网络监控与故障排查是保障系统稳定运行的关键环节。无论是运维工程师、网络管理员，还是安全研究人员，都需要熟练掌握一系列网络探测与分析工具。本文将围绕 <strong>ping、traceroute、nmap、Wireshark</strong> 四种经典工具展开，介绍它们的原理、使用方法及应用场景。</p><h2 id="_1-ping-最基础的连通性测试工具" tabindex="-1"><a class="header-anchor" href="#_1-ping-最基础的连通性测试工具"><span>1. Ping：最基础的连通性测试工具</span></a></h2><ul><li><p><strong>原理</strong>：通过发送 ICMP Echo 请求并等待 Echo Reply，检测目标主机是否可达。</p></li><li><p>常见用途：</p><ul><li>测试主机是否在线</li></ul></li><li><p>测量往返时延（RTT）</p><ul><li>检查丢包率</li></ul></li><li><p>示例：</p><div class="language-bash line-numbers-mode" data-highlighter="shiki" data-ext="bash" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-bash"><span class="line"></span></code></pre><div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0;"><div class="line-number"></div></div></div></li></ul><p>ping www.baidu.com</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span></span></span>
