import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as i,o as e}from"./app-w0bMFjFL.js";const l={};function p(t,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="nginx从入门到放弃04-反向代理、正向代理、负载均衡" tabindex="-1"><a class="header-anchor" href="#nginx从入门到放弃04-反向代理、正向代理、负载均衡"><span>Nginx从入门到放弃04-反向代理、正向代理、负载均衡</span></a></h1><p>通过前面几篇的文章，我们知道nginx最主要的功能之一可以做负载均衡器、正向代理和反向代理，今天我们就来学习如何利用nginx配置</p><p>笔者把自己总结的文档分为几遍，合集在 https://g.xgss.net/nginx/</p><p><img src="https://imgoss.xgss.net/picgo/nginx04.jpg?aliyun" alt="nginx04"></p><h1 id="反向代理" tabindex="-1"><a class="header-anchor" href="#反向代理"><span>反向代理</span></a></h1><p>局域网中的电脑用户想要直接访问网络是不可行的，只能通过代理服务器来访问，这种代理服务就被称为正向代理。</p><p><img src="https://imgoss.xgss.net/picgo/image-20220623175659268.png?aliyun" alt="image-20220623175659268"></p><p>单台服务器nginx配置如下</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>server {  </span></span>
