import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as i,o as e}from"./app-B4PqXO1v.js";const l={};function p(d,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="rocky-linux-9-安装ftp服务器搭建实战-一文学会-高效文件传输" tabindex="-1"><a class="header-anchor" href="#rocky-linux-9-安装ftp服务器搭建实战-一文学会-高效文件传输"><span>Rocky Linux 9 安装FTP服务器搭建实战：一文学会，高效文件传输！</span></a></h1><p>大家好，我是星哥，之前的文章中介绍了在Rocky Linux 9系统中安装LNMP，今天继续来安装vsftpd软件。</p><p>文件传输的效率和安全性至关重要。FTP（File Transfer Protocol）作为一种经典的文件传输协议，在许多场景下依然扮演着不可或缺的角色。</p><p>本文将详细介绍如何在Rocky Linux 9上安装和配置FTP服务器，帮助您快速搭建一个稳定高效的文件传输平台。</p><p><img src="https://imgoss.xgss.net/picgo-tx2025/QQ_1752825175735.png?tx" alt="img"></p><h1 id="快速安装" tabindex="-1"><a class="header-anchor" href="#快速安装"><span>快速安装</span></a></h1><p>功能：Rocky Linux 9系统中源码包安装 Vsftpd 的shell脚本</p><p>端口：62920</p><p>FTP用户： www</p><p>FTP日志存放路径： /data/wwwroot/ftp_log/</p><p>登录用户名和密码： yxkj_web Password123 【请修改密码】</p><p>FTP配置文件：/data/conf/vsftpd/vsftpd.conf</p><p>被动模式端口范围： 9000-9045</p><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span># 使用：</span></span>
