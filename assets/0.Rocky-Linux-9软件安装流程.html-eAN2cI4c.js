import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as a,b as i,o as e}from"./app-B4PqXO1v.js";const l={};function p(d,s){return e(),a("div",null,s[0]||(s[0]=[i(`<h1 id="软件安装流程" tabindex="-1"><a class="header-anchor" href="#软件安装流程"><span>软件安装流程</span></a></h1><h2 id="系统初始化-必须" tabindex="-1"><a class="header-anchor" href="#系统初始化-必须"><span>系统初始化（必须）</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code class="language-"><span class="line"><span>dnf install -y wget</span></span>
